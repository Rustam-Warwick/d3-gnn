...
//        NDHelper.loadModel(Path.of(System.getenv("DATASET_DIR"), "ogb-products", "graphSage"), model);
        model.getBlock().initialize(BaseNDManager.getManager(), DataType.FLOAT32, new Shape(3));
    ...
    public static void main(String[] args) throws Throwable {
        try {
            ...
            config.set(MetricOptions.REPORTERS_LIST, "nativeMemoryReporter");
            config.setString("metrics.reporter.nativeMemoryReporter.factory.class", "org.apache.flink.metrics.reporter.NativeMemoryReporter");
