...
public final class NDSerializer {
    ...
    public static void encodeAsNumpy(NDArray array, OutputStream os) throws IOException {
     ...
     */
    public static NDArray decode(NDManager manager, InputStream is) throws IOException {
        DataInputStream dis;
