...
abstract public class BaseStreamingGNNAggregator<VT extends BaseVertex> extends BaseAggregator<VT> {
    ...
    public void startGNNCell(Short l, BaseVertex v){
         ...
         v.parts.getValue().whenComplete((parts,thr)->{
             ...
             GraphQuery gQuery = BaseStreamingGNNAggregator.prepareQuery(query);
            ...
            case AGG : {
                ...
                if(incomingQuery.op == GNNQuery.OPERATORS.REQUEST){
                    ...
                    res.whenComplete((val,err)->{
                        ...
                        GraphQuery query = BaseStreamingGNNAggregator.prepareQuery(incomingQuery);
